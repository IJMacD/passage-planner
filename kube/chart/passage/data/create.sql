...
CREATE TABLE IF NOT EXISTS `logbook` (
  ...
  `twilight_begin` time DEFAULT NULL,
  `twilight_end` time DEFAULT NULL,
...
CREATE TABLE `logbook_entry_track` (
	...
	`twilight_begin` TIME NULL,
	`twilight_end` TIME NULL,
